...
import 'package:unten_user/assistants/geofire_assistant.dart';
import 'package:unten_user/global/global.dart';
import 'package:unten_user/infoHandler/app_info.dart';
import 'package:unten_user/mainScreens/rate_driver_screen.dart';
import 'package:unten_user/mainScreens/search_places_screen.dart';
import 'package:unten_user/mainScreens/select_nearest_active_driver_screen.dart';
import 'package:unten_user/models/active_nearby_available_drivers.dart';
import 'package:unten_user/widgets/my_drawer.dart';
import 'package:unten_user/widgets/pay_fare_amount_dialog.dart';
...
class _MainScreenState extends State<MainScreen>
{
  ...
  saveRideRequestInformation()
  {
    ...
    tripRideRequestInfoStreamSubscription = referenceRideRequest!.onValue.listen((eventSnap) async
    {
      ...
      {
        setState(() {
          driver_Details = (eventSnap.snapshot.value as Map)["driver_details"].toString();
        });
      }
  ...
  createActiveNearByDriverIconMarker()
  {
    if(activeNearbyIcon == null)
    {
      ...
      BitmapDescriptor.fromAssetImage(imageConfiguration, "images/driver_location.png").then((value)
      {
